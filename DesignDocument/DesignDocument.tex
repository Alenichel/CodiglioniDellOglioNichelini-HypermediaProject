...
Missing wireframe
% TODO: missing wireframe: homepage
...
\begin{figure}[H]
    ...
    \caption{Mockup}
\end{figure}
% TODO: missing comments on mockup
...
Missing wireframe
% TODO: missing wireframe: kind of topic service (DONE)
...
\begin{figure}[H]
    ...
    \caption{Wireframe}
\end{figure}
% TODO: missing transition link (DONE)
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth, keepaspectratio]{mockups/ConcreteEventsByMonth}
    \caption{Mockup}
\end{figure}
